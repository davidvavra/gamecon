...
class Uzivatel {
  ...
  /** Vrátí adresu uživatele ve formátu Město, Ulice ČP, PSČ, stát*/
  function adresa() {
  ...
  /** Vrátí datum narození uživatele jako string ve formátu dd.mm.rrrr nebo prázdný řetězec*/
  public function datumNarozeniCZ() {
    if((int)$this->u['datum_narozeni']) {
  ...
  /** Vrátí číslo občanského průkazu uživatele */
